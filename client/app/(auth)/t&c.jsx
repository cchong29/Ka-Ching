  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <ThemedText style={styles.text}>
        By using Ka-Ching!, you agree to these terms and conditions in full. If
        you disagree with any part, do not use the app.
      </ThemedText>

      <ThemedText style={styles.subheading}>2. Use of the App</ThemedText>
      <ThemedText style={styles.text}>
        You must use the app only for lawful purposes. Misuse of the app may
        result in access restrictions or bans.
      </ThemedText>
      ...
      <ThemedText style={styles.text}>
        All content on Ka-Ching! is owned by the app developers unless otherwise
      ...
      <ThemedText style={styles.text}>
        ...
        the app implies acceptance of the changes.
      </ThemedText>
    </ScrollView>
  );
}
